...
!                .      .    .                                       .
! subprogram:	 module gsi_tdOper
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2018-08-10
!
! abstract: an obOper extension for tdNode type
!
! program history log:
!   2018-08-10  j guo   - added this document block
!   2019-06-25  Hu      - add diag_radartd for controling radar reflectivity
!                         diag file (in module obsmod).
!   2019-07-22  j Guo   - moved diag_radartd and its description here from
!                         obsmod.
!
...
! module interface:
  ...
  implicit none
  public:: tdOper      ! data stracture
  public:: diag_radartd

  type,extends(obOper):: tdOper
  contains
...
!   def diag_radartd- namelist logical to compute/write (=true) radar
!                                          reflectiivty diag files
  logical,save:: diag_radartd=.false.

!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  character(len=*),parameter :: myname='gsi_tdOper'
  type(tdNode),save,target:: myNodeMold_
...
contains
  ...
  subroutine setup_(self, lunin, mype, is, nobs, init_pass,last_pass)
    ...
    implicit none
    class(tdOper ), intent(inout):: self
